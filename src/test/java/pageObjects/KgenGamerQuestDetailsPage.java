...
//	By  = By.xpath("");
	...
	public void submitProof() throws InterruptedException {
		WebDriverWait wait = new WebDriverWait(LocalDriverFactory.getInstance().getLocalDriver() ,Duration.ofSeconds(200));
		...
		try {
            WebElement popup = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("button[@class='button_buttonBody__CW6b6 button_variant-primary__XZGfJ kcash-bonus-Modal_contentAmountInnerClaimDiv__HUArD")));
            ...
            System.out.println("Popup not found or already closed."); //change this to extent factory statement
        }
